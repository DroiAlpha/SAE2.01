...
# Selon le goat on doit pip install tout ça pip install langchain langgraph langchain-core langchain-community langchain-huggingface huggingface-hub faiss-cpu python-dotenv
